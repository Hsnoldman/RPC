...
inline void RegRequest::set_name(const void* value, size_t size) {
...
inline void RegRequest::set_pwd(const void* value, size_t size) {
...
inline void Response::set_errormsg(const void* value, size_t size) {
